...
exports.STOMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS STOMST " +
    "(" +
...
exports.STOVAN = function() {
  return (
    "CREATE TABLE IF NOT EXISTS STOVAN " +
    "(" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT          NULL, " +
...
exports.CPNMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS CPNMST " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
...
exports.USRSTO = function() {
  return (
    "CREATE TABLE IF NOT EXISTS USRSTO " +
    " ( " +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `USERID`  VARCHAR(20)  CHARACTER SET utf8  NULL, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.POSTIM = function() {
  return (
    "CREATE TABLE IF NOT EXISTS POSTIM " +
    " ( " +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.ADMMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS ADMMST " +
    " ( " +
    " `ID`   INT             NOT NULL    AUTO_INCREMENT, " +
...
exports.NCALL2 = function() {
  return (
    "CREATE TABLE IF NOT EXISTS NCALL2 " +
    " ( " +
    "   `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    "   `STOSEQ`  INT            NULL, " +
...
exports.NCALL2INFO = function() {
  return (
    "CREATE TABLE IF NOT EXISTS NCALL2INFO " +
    " ( " +
    "    `ID`        INT           NOT NULL    AUTO_INCREMENT, " +
    "    `STOSEQ`    INT           NULL, " +
...
exports.STOCAL = function() {
  return (
    "CREATE TABLE IF NOT EXISTS STOCAL " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.TBLSTO = function() {
  return (
    "CREATE TABLE IF NOT EXISTS TBLSTO " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `FLRSEQ`  INT            NULL, " +
...
exports.DLVSTO = function() {
  return (
    "CREATE TABLE IF NOT EXISTS DLVSTO " +
    " ( " +
    " `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.STOFLR = function() {
  return (
    "CREATE TABLE IF NOT EXISTS STOFLR " +
    "(" +
    "    `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    "    `STOSEQ`  INT            NULL, " +
...
exports.STODVC = function() {
  return (
    "CREATE TABLE IF NOT EXISTS STODVC " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.ALRADV = function() {
  return (
    "CREATE TABLE IF NOT EXISTS ALRADV " +
    " ( " +
    " `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT             NULL, " +
...
exports.POSRPS = function() {
  return (
    "CREATE TABLE IF NOT EXISTS POSRPS " +
    " ( " +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `POSID`   VARCHAR(20)  CHARACTER SET utf8  NULL, " +
...
exports.EVTFIL_M = function() {
  return (
    "CREATE TABLE IF NOT EXISTS EVTFIL_M " +
    " ( " +
    " `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT             NULL, " +
    " `EVTSEQ`  INT             NULL, " +
...
exports.EVTFIL_D = function() {
  return (
    "CREATE TABLE IF NOT EXISTS EVTFIL_D " +
    " (" +
    "     `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `EVTSEQ`  INT             NULL, " +
...
exports.PRDFIL_M = function() {
  return (
    "CREATE TABLE IF NOT EXISTS PRDFIL_M " +
    " (" +
    " `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `PRDSEQ`  INT             NULL, " +
...
exports.PRDFIL_D = function() {
  return (
    "CREATE TABLE IF NOT EXISTS PRDFIL_D " +
    " (" +
    " `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `PRDSEQ`  INT             NULL, " +
...
exports.PRDOPT = function() {
  return (
    "CREATE TABLE IF NOT EXISTS PRDOPT " +
    " ( " +
    " `ID`      INT    NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `PRDSEQ`  INT    NULL, " +
...
exports.OPTMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS OPTMST " +
    " ( " +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `OPTCAT`  INT            NULL, " +
...
exports.OPTCAT = function() {
  return (
    "CREATE TABLE IF NOT EXISTS OPTCAT " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.EVTMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS EVTMST " +
    " ( " +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.PRDSET = function() {
  return (
    "CREATE TABLE IF NOT EXISTS PRDSET " +
    " ( " +
    " `ID`      INT    NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `SETSEQ`  INT    NULL, " +
...
exports.SETMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS SETMST" +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.USRSAL = function() {
  return (
    "CREATE TABLE IF NOT EXISTS USRSAL " +
    " ( " +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `RCNSEQ`  INT            NULL, " +
...
exports.RCNOPT = function() {
  return (
    "CREATE TABLE IF NOT EXISTS RCNOPT " +
    " ( " +
    " `ID`      INT    NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `RCNSEQ`  INT    NULL, " +
...
exports.PRDMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS PRDMST " +
    " ( " +
    " `ID`      INT             NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `CATSEQ`  INT             NULL, " +
...
exports.DISMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS DISMST " +
    " ( " +
    " `ID`      INT           NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.SALPRD = function() {
  return (
    "CREATE TABLE IF NOT EXISTS SALPRD " +
    " ( " +
    " `ID`      INT           NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `RCNSEQ`  INT           NULL, " +
...
exports.SALMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS SALMST " +
    " (" +
    "     `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    "     `STOSEQ`  INT            NULL, " +
...
exports.CATMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS CATMST " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
    " `CATNAM`  VARCHAR(40)    CHARACTER SET utf8  NULL, " +
...
exports.SALSIO = function() {
  return (
    "CREATE TABLE IF NOT EXISTS SALSIO " +
    " (" +
...
exports.RCNMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS RCNMST " +
    " (" +
    " `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT            NULL, " +
...
exports.RCNRCT = function() {
  return (
    "CREATE TABLE IF NOT EXISTS RCNRCT " +
    " (" +
    " `ID`      INT           NOT NULL      AUTO_INCREMENT, " +
    " `STOSEQ`  INT           NULL, " +
...
exports.RCNDET = function() {
  return (
    "CREATE TABLE IF NOT EXISTS RCNDET " +
    " (" +
...
exports.OPTSET = function() {
  return (
    "CREATE TABLE IF NOT EXISTS OPTSET " +
    " (" +
    " `ID`         INT    NOT NULL    AUTO_INCREMENT, " +
    " `STOSEQ`  INT           NULL,                   " +
...
exports.CALMST = function() {
  return (
    "CREATE TABLE IF NOT EXISTS CALMST " +
    " (" +
    "     `ID`      INT            NOT NULL    AUTO_INCREMENT, " +
...
exports.NCALL = function() {
  return (
    "CREATE TABLE IF NOT EXISTS NCALL " +
    " (" +
    "     `ID`      INT           NOT NULL    AUTO_INCREMENT, " +
    "     `STOSEQ`  INT           NULL        COMMENT '가게 번호', " +
...
exports.ADDADMIN = function() {
  return (
    "INSERT INTO ADMMST (ADMID, ADMPW, ADMNAM) " +
